        ...
        <div className="relative md:left-[20%] xl:left-[20%] md:w-[80%] z-10 mt-16 md:mt-5 p-5 pt-10 flex flex-col items-center  justify-center gap-4">
          ...
          <div className="w-full max-w-7xl mx-auto my-12 px-4">
            <div className="relative h-1 bg-gray-200 rounded-full overflow-hidden">
              <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-r from-purpl via-orang to-pin before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent before:animate-[shimmer_2s_infinite] before:translate-x-[-100%]"></div>
            </div>
          </div>
        </div>
          ...
          <div className="container flex flex-col justify-between py-10 px-4 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            ...
            <div className="">
              <a rel="noopener noreferrer" href="#" className="flex justify-center gap-2 lg:justify-start items-center">
                ...
                <div className="flex items-center justify-center  rounded-full bg-green-400 dark:bg-green-600 lg:w-26 lg:h-24">
                  <img
                ...
                <span className="self-center text-2xl font-semibold">KidsLe</span>
              </a>
            </div>
